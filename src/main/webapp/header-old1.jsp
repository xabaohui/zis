...
<html>
	...
	<body>
		<div class="left" style="height: 100%;">
			...
			<ul class = "uls" onclick="checked(this);">
			<font style="font-weight: bolder;">公司管理</font>
				<ul name = "showListTop" style="display: none" class = "showListTop">
			...
			<font style="font-weight: bolder;">商品管理</font>
				<ul name = "showListTop" style="display: none" class = "showListTop">
						<li><a href="storage/stock/listProducts">商品管理</a></li>
						<br/>
				</ul>
			</ul>
			</shiro:hasPermission>
			...
			<font style="font-weight: bolder;">库存管理(新)</font>
				<ul name = "showListTop" style="display: none" class = "showListTop">
						...
						<li><a href="storage/stock/listProducts">商品管理</a></li>
						<br/>
						<li><a href="storage/findPosition">库位管理</a></li>
						<br/>
				</ul>
			</ul>
			</shiro:hasPermission>
			<shiro:hasPermission name="order:storageOrder">
			<ul class = "uls" onclick="checked(this);">
			<font style="font-weight: bolder;">商品进销存</font>
				<ul name = "showListTop" style="display: none" class = "showListTop">
						<br/>

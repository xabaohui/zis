...
<form action="addAmount" method="post">
	...
	<table>
		<tr>
			<td>学校：</td>
			<td><input name="college" type="text" disabled="disabled" />
			</td>
		</tr>
		<tr>
			<td>学院：</td>
			<td><input name="institute" type="text" disabled="disabled" />
			</td>
		</tr>
		<tr>
			<td>专业：</td>
			<td><input name="partName" type="text" disabled="disabled" />
			</td>
		</tr>
	</table>
	<%

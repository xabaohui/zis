...
public class PurchasePlanViewController extends PaginationQueryController<PurchasePlan> {
	...
	@Override
	protected Specification<PurchasePlan> buildQueryCondition(HttpServletRequest request) {
	...
	@Override
	protected Page<PurchasePlan> buildPageList(Specification<PurchasePlan> spec, Pageable page) {

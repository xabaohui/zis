...
public class TaobaoItemCsvExportByInwarehouseAction extends
	...
	private Map<String, InwarehouseDetail> uniqueIsbnDealt = new HashMap<String, InwarehouseDetail>();//已处理的记录，导出的时候判断重复项用
	...
	@Override
	protected Collection<InwarehouseDetail> transformList(

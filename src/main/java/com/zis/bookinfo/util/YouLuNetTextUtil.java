...
public class YouLuNetTextUtil {
	 ...
	 * @return
	 */
	public static String clearBookAuthor(String bookAuthor) {
		...
		bookAuthor = TextClearUtils.deleteString(bookAuthor, "原著", "译",
				TextClearUtils.MATCH_MODE_FORCE_END);
		bookAuthor = TextClearUtils.deleteString(bookAuthor, "著", "译",
				TextClearUtils.MATCH_MODE_FORCE_END);
		// 删除结尾的“等”、“著”、“编”
		bookAuthor = TextClearUtils.deleteString(bookAuthor, "等", null,
				TextClearUtils.MATCH_MODE_FORCE_END);
		bookAuthor = TextClearUtils.deleteString(bookAuthor, "著", null,
				TextClearUtils.MATCH_MODE_FORCE_END);
		bookAuthor = TextClearUtils.deleteString(bookAuthor, "编", null,
				TextClearUtils.MATCH_MODE_FORCE_END);
		bookAuthor = TextClearUtils.deleteString(bookAuthor, " 辑", null,
				TextClearUtils.MATCH_MODE_FORCE_END);
		// 作者重复，例如“张三 张三”

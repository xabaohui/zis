...
public interface BookInfoDao extends PagingAndSortingRepository<Bookinfo, Integer>, JpaSpecificationExecutor<Bookinfo>,
		JpaRepository<Bookinfo, Integer> {
	 ...
	 * @return
	 */
	Bookinfo findByIdAndIsbn(Integer id, String isbn);
	...
	List<Bookinfo> findByBookNameAuthorPublisher(@Param(value = "bookName") String bookName,
	...
	List<Bookinfo> findByGroupIdAndPublisher(@Param(value = "groupId") String groupId,

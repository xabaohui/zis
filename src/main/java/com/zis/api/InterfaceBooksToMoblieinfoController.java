...
public class InterfaceBooksToMoblieinfoController extends BaseApiController {
	...
	private static Logger logger = Logger.getLogger(InterfaceBooksToMoblieinfoController.class);

	@RequestMapping(value = "/addBookInfo", produces = "text/plain; charset=utf-8")
	public String addBookInfo(String isbn, String bookName, String bookAuthor, String publisher, String publishDate,
			String price, String edition, HttpServletResponse resp, String token) {
		logger.info("api.InterfaceBooksToMoblieinfoAction.addBookInfo--" + "isbn=" + isbn + " bookName=" + bookName
				+ " bookAuthor=" + bookAuthor + " publisher=" + publisher + " publishDate=" + publishDate + " price="
	...
	private String validateParam(String isbn, String bookName, String publishDate, String price) {

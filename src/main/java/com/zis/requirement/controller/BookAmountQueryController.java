...
public class BookAmountQueryController {
	...
	private void setQueryConditionToPage(String isbn, String bookName, String school, String institute,
			String partName, Integer grade, Integer term, String operator, HttpServletRequest request, ModelMap context) {
	...
	private Specification<BookAmount> buildSpec(String isbn, String bookName, String school, String institute,
			String partName, Integer grade, Integer term, String operator) {

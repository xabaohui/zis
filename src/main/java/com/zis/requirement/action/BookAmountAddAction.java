...
public class BookAmountAddAction extends ActionSupport {
	...
	private static Logger logger = Logger.getLogger(BookAmountAddAction.class);
	...
	@Validations(
	// 学年学期不能为空
	requiredFields = { @RequiredFieldValidator(fieldName = "term", key = "学期不能为空") },
	// 学年学期区间
	intRangeFields = { @IntRangeFieldValidator(fieldName = "term", min = "1", max = "2", key = "学期在1和2之间") },
	// 学年学期只能填数字
	conversionErrorFields = {
			@ConversionErrorFieldValidator(fieldName = "amount", key = "数量只能填数字", shortCircuit = true),
	...
	public String addAmount() {
		...
		Map<Integer, Bookinfo> map = (Map<Integer, Bookinfo>) session

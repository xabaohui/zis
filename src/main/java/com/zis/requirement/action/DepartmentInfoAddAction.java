...
public class DepartmentInfoAddAction extends ActionSupport {
	...
	private static Logger logger = Logger
			.getLogger(DepartmentInfoAddAction.class);
	...
	// 不能为空
	requiredStrings = {
			@RequiredStringValidator(fieldName = "college", trim = true, key = "学校不能为空"),
			@RequiredStringValidator(fieldName = "institute", trim = true, key = "学院不能为空"),
			@RequiredStringValidator(fieldName = "partName", trim = true, key = "专业不能为空") }, 
	requiredFields = { @RequiredFieldValidator(fieldName = "years", key = "学年制不能为空") })

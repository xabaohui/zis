...
public class ShopAllItemPublishBoImpl implements ShopAllItemPublishBo {
	...
	/**
	 * 补全信息,转换为ApiAddItemDto
	 * 
	 * @param mappings
	 * @param shop
	 * @return
	 */
	private List<ApiAddItemDto> buildApiAddItemDtos(List<ShopItemMapping> mappings, ShopInfo shop) {
	 ...
	 * @return
	 */
	private ApiAddItemDto getDto2DB(ShopItemMapping mapping, ShopInfo shop) {

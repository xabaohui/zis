...
public class ShopController {
	...
	private final String OPERATE_TYPE_UPDATE = "updateShop";
	private final String OPERATE_TYPE_ADD = "addShop";
	private final String P_NAME_TAOBAO = "taobao";
	...
	public String saveOrUpdateShop(@Valid @ModelAttribute("dto") SaveOrUpdateShopDto dto, BindingResult br, ModelMap map) {
		map.put("shop", dto);
		if (br.hasErrors()) {
			return "shop/shop/saveOrUpdate/save-or-update-shop";
		}

...
public abstract class AbstractApiTransfer implements ApiTransfer {

	/**
	 * 构建描述详情
	 * 
	 * @param bookinfoDetail
	 * @return
	 */
	protected String buildDesc(ApiAddItemDto dto) {
	...
	protected InputStream getInputStream(String urlStr) {
		...
		if (StringUtils.isBlank(urlStr)) {
			urlStr = "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec="
					+ "1486234209743&di=aa7f46550856899c55ced8b0c7af05ce&imgtype=0&src=http%3A%2F%2Fpages.haozu.ajkcdn."
					+ "com%2F20111117%2Fimg%2Fprop%2Fnopic_385x240.gif";
		}
		InputStream is = null;
		try {
			// 构造URL
